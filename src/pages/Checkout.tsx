...
const Checkout: React.FC = () => {
  ...
  const [bookingStatus, setBookingStatus] = useState<"pending" | "paid" | "failed" | "cancelled">(
    "pending"
  );
  const [isLoadingStatus, setIsLoadingStatus] = useState(true);
  const [discountInfo, setDiscountInfo] = useState<{ available: boolean; remainingSlots: number }>({
    available: false,
    remainingSlots: 0,
  });

  const imgNextElementSiblingRef = useRef<HTMLDivElement | null>(null)
  ...
  if (!bookingData || !bookingPersonsData || !packageData || !currentBookingReference) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen text-center text-gray-600">
        ...
        <p>Missing booking information. Please return to the home page.</p>
      </div>
    );
  }
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-600">
                  Booking {currentBookingReference} -{" "}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-green-100">
                      You're eligible for a 15% discount! Only {discountInfo.remainingSlots} spots
                      left in our first 100 payments promotion.
                    </p>
                  </div>
                </div>
              </motion.div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
                  ...
                  <div className="mb-4 text-sm">
                    ...
                    <div className="flex justify-between font-bold">
                      ...
                      <span className="text-secondary text-lg">${finalPrice.toFixed(2)} USD</span>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <div className="flex items-start">
                      ...
                      <p className="text-blue-800 text-sm">
                        Your payment will be processed securely through Konnect, Tunisia's trusted
                        payment gateway. All payment information is encrypted and secure. All prices
                        are in USD.
                      </p>
                    </div>
                  </div>
                  ...
                  {bookingStatus === "paid" ? (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                      ...
                      <button onClick={() => navigate("/success")} className="button-primary">
                        View Confirmation
                      </button>
                    </div>
                  ) : (
                    ...
                    <div className="grid grid-cols-1 gap-4 mb-6">
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                        <div className="flex items-center justify-center mb-4">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              imgNextElementSiblingRef.current!.style.display = "block";
                            }}
                          />
                          <div
                          ref={imgNextElementSiblingRef}
                            style={{ display: "none" }}
                        ...
                        <p className="text-xs text-gray-500 mt-4">
                          You will be redirected to Konnect's secure payment page to complete your
                          transaction.
                        </p>
                      </div>
                    </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <ol className="space-y-4 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <p>
                        You'll be redirected to Konnect's secure payment page to complete your
                        transaction.
                      </p>
                    </li>
                    <li className="flex items-start">
                      ...
                      <p>
                        After successful payment, you'll receive a confirmation email with your
                        booking details.
                      </p>
                    </li>
                    <li className="flex items-start">
                      ...
                      <p>
                        Our team will contact you to confirm all arrangements and provide detailed
